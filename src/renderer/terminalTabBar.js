...
class TerminalTabBar {
  ...
  _render() {
    ...
    this.element.innerHTML = `
      ...
      <div class="terminal-tab-actions">
        ...
        <button class="btn-agents-toggle" title="Toggle Agents Panel (Ctrl+Shift+A)">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <button class="btn-skills-toggle" title="Toggle Skills Panel (Ctrl+Shift+S)">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  _setupEventHandlers() {
    ...
    this.element.querySelector('.btn-agents-toggle').addEventListener('click', () => {
      agentsPanel.toggle();
    });
